...
- **Slot-binding grace across a transient guest drop (D-40/D-M5.5-3).** A guest's
  ...
  host action and no placeholder flash** (AC-3). If the guest never returns, the
  ...
  (kick D-25 / evict / source rotation) and the **screenshare** slot (a live action,
  not a persistent identity, D-21) still vacate immediately. The grace stays far
